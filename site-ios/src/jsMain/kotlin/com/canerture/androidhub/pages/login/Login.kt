            ...
            Row(
                ...
                SpanText(
                    modifier = Modifier
                        ...
                        .color(if (loginRegisterState == LoginRegisterState.Login) getSitePalette().secondary else getSitePalette().white)
                        .backgroundColor(if (loginRegisterState == LoginRegisterState.Login) getSitePalette().primary else getSitePalette().secondary)
                ...
                SpanText(
                    modifier = Modifier
                        ...
                        .padding(topBottom = 10.px)
                        .fontWeight(FontWeight.Medium)
                        .color(if (loginRegisterState == LoginRegisterState.Register) getSitePalette().secondary else getSitePalette().white)
                        .backgroundColor(if (loginRegisterState == LoginRegisterState.Register) getSitePalette().primary else getSitePalette().secondary)
                        .transition(CSSTransition(property = "background-color", duration = 400.ms))
                        .cursor(Cursor.Pointer)
                        .onClick {
