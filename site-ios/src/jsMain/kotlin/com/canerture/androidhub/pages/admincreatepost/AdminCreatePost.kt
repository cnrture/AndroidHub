...
private fun CategoryArea(
    ...
    SimpleGrid(
        ...
        categoryList.forEach { category ->
            Checkbox(
                modifier = Modifier.color(getSitePalette().primary).margin(12.px),
                size = CheckboxSize.LG,
                borderColor = getSitePalette().primary,
    ...
    Row(
        ...
        Button(
            attrs = Modifier
                ...
                .height(54.px)
                .backgroundColor(if (!thumbnailInputDisabled) getSitePalette().gray else getSitePalette().secondary)
                .color(getSitePalette().white)
                .borderRadius(r = 4.px)
                .noBorder()
            ...
            Box(contentAlignment = Alignment.CenterEnd) {
                Button(
                    attrs = Modifier
                        ...
                        .borderRadius(r = 4.px)
                        .backgroundColor(
                            if (editorVisibility) getSitePalette().secondary
                            else getSitePalette().primary
                        )
                        .color(
...
val EditorKeyStyle by ComponentStyle {
    ...
    hover {
        Modifier.backgroundColor(getSitePalette().primary)
    }
}