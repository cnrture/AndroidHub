...
object Res {
    object Image {
        const val LOGO = "/ioshub-logo.webp"
        const val LOGO_DARK = "/ioshub-logo-dark.webp"
        const val IOS_FIGURE = "/ios-figure.webp"
        const val JETPACK = "/jetpack.webp"
    }

    object Icon {
        const val BOLD = "/bold.png"
        const val ITALIC = "/italic.png"
        const val LINK = "/link.png"
        const val TITLE = "/title-subtitle.png"
        const val SUBTITLE = "/title-subtitle.png"
        const val QUOTE = "/quote.png"
        const val CODE = "/code.png"
...
object Id {
    ...
    const val NAVBAR_SEARCH_INPUT = "navbarSearchInput"
}