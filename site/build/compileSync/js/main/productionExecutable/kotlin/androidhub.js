(function (root, factory) {
  ...
  var toInt = kotlin_kotlin.$_$.c8;
  var charSequenceLength = kotlin_kotlin.$_$.m5;
  var toBoolean = kotlin_kotlin.$_$.b8;
  ...
  function main() {
    ...
    get_api(window).c2j(true);
    Companion_instance.x2k('');
    var router = new Router();
    initKobweb(router, main$lambda);
    router.l2m(LegacyRouteRedirectStrategy_DISALLOW_getInstance());
    router.m2m(main$lambda_0);
    set_additionalSilkInitialization(main$lambda_1);
    router.s2k(removePrefix(window.location.href, window.location.origin), UpdateHistoryMode_REPLACE_getInstance());
    var root = ensureNotNull(document.getElementById('root'));
    while (!(root.firstChild == null)) {
      root.removeChild(ensureNotNull(root.firstChild));
    }
    AppGlobals_instance.k2j(mapOf(to('title', '.')));
  ...
  function ComposableSingletons$MainKt() {
    ...
    var tmp = this;
    tmp.u36_1 = ComposableLambda$invoke$ref(composableLambdaInstance(-994802423, false, ComposableSingletons$MainKt$lambda_1$lambda_sdpc0d));
    var tmp_0 = this;
    tmp_0.v36_1 = ComposableLambda$invoke$ref_0(composableLambdaInstance(-1296252800, false, ComposableSingletons$MainKt$lambda_2$lambda_dts8wk));
    var tmp_1 = this;
    tmp_1.w36_1 = ComposableLambda$invoke$ref_1(composableLambdaInstance(1940211355, false, ComposableSingletons$MainKt$lambda_3$lambda_ezu85n));
  }
  ...
  function main$lambda(ctx) {
    ctx.h2k_1.k2m('/', VOID, ComposableSingletons$MainKt_getInstance().u36_1);
    ctx.h2k_1.k2m('/about', VOID, ComposableSingletons$MainKt_getInstance().v36_1);
    return Unit_instance;
  }
  function main$lambda_0($this$addRouteInterceptor) {
    $this$addRouteInterceptor.q2m(removeSuffix(removeSuffix($this$addRouteInterceptor.e2m_1, '.html'), '.htm'));
    return Unit_instance;
  }
  function main$lambda_1(ctx) {
    initSilkWidgets(ctx);
    initSilkWidgetsKobweb(ctx);
    ctx.o2t_1.x2t(get_HeadlineTextStyle());
    ctx.o2t_1.x2t(get_SubheadlineTextStyle());
    ctx.o2t_1.x2t(get_MarkdownStyle());
    ctx.o2t_1.x2t(get_PageContentStyle());
    ctx.o2t_1.x2t(get_FooterStyle());
    ctx.o2t_1.x2t(get_NavHeaderStyle());
    ctx.o2t_1.x2t(get_HeroContainerStyle());
    ctx.o2t_1.x2t(get_HomeGridStyle());
    ctx.o2t_1.x2t(get_HomeGridCellStyle());
    ctx.o2t_1.g2u([get_CircleButtonVariant()]);
    ctx.o2t_1.g2u([get_UncoloredButtonVariant()]);
    registerKeyframes(ctx.n2t_1, get_SideMenuSlideInAnim());
    initColorMode(ctx);
    initSiteStyles(ctx);
    initTheme(ctx);
    return Unit_instance;
  ...
  function main$lambda$lambda($router) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 11) === 2) ? true : !$composer_0.n17()) {
        ...
        $router.h2m(ComposableSingletons$MainKt_getInstance().w36_1, $composer_0, 70, 0);
        var tmp_0;
        if (isTraceInProgress()) {
          traceEventEnd();
          tmp_0 = Unit_instance;
  ...
  function AboutPage($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(-2053218993);
    if (!($changed === 0) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
        traceEventStart(-2053218993, $changed, -1, 'com.canerture.androidhub.pages.AboutPage (About.kt:8)');
      }
      MarkdownLayout('About', ComposableSingletons$AboutKt_getInstance().n39_1, $composer_0, 54);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(AboutPage$lambda($changed));
    }
  }
  ...
  function ComposableSingletons$AboutKt$lambda_8$lambda_7fvxa4($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().d37_1, $composer_0, 48, 1);
    Text('.', $composer_0, 6);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
  ...
  function ComposableSingletons$AboutKt$lambda_16$lambda_lzur0j($this$Li, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().l37_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda_20$lambda_bqdg8s($this$Li, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().p37_1, $composer_0, 48, 1);
    GenericTag('br', null, null, $composer_0, 54, 4);
  ...
  function ComposableSingletons$AboutKt$lambda_21$lambda_h390tf($this$Ul, $composer, $changed) {
    ...
    Li(null, ComposableSingletons$AboutKt_getInstance().m37_1, $composer_0, 48, 1);
    Li(null, ComposableSingletons$AboutKt_getInstance().o37_1, $composer_0, 48, 1);
    Li(null, ComposableSingletons$AboutKt_getInstance().q37_1, $composer_0, 48, 1);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$AboutKt$lambda_26$lambda_j55a66($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().u37_1, $composer_0, 48, 1);
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().v37_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda_29$lambda_ykwndn($this$Li, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().y37_1, $composer_0, 48, 1);
    GenericTag('br', null, null, $composer_0, 54, 4);
  ...
  function ComposableSingletons$AboutKt$lambda_31$lambda_csuzz0($this$Li, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().a38_1, $composer_0, 48, 1);
    GenericTag('br', null, null, $composer_0, 54, 4);
  ...
  function ComposableSingletons$AboutKt$lambda_32$lambda_g0rh37($this$Ul, $composer, $changed) {
    ...
    Li(null, ComposableSingletons$AboutKt_getInstance().z37_1, $composer_0, 48, 1);
    Li(null, ComposableSingletons$AboutKt_getInstance().b38_1, $composer_0, 48, 1);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$AboutKt$lambda_37$lambda_i2nqfy($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().g38_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda_40$lambda_hhfui($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().j38_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda_47$lambda_btgach($this$P, $composer, $changed) {
    ...
    Em(null, ComposableSingletons$AboutKt_getInstance().q38_1, $composer_0, 48, 1);
  ...
  function ComposableSingletons$AboutKt$lambda_50$lambda_udlgmx($this$Pre, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().t38_1, $composer_0, 48, 1);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$AboutKt$lambda_57$lambda_tbjqu8($this$P, $composer, $changed) {
    ...
    Em(null, ComposableSingletons$AboutKt_getInstance().y38_1, $composer_0, 48, 1);
    Text(' and ', $composer_0, 6);
    Em(null, ComposableSingletons$AboutKt_getInstance().z38_1, $composer_0, 48, 1);
    Text('. You can ', $composer_0, 6);
    Link('https://github.com/varabyte/kobweb#static-layout-vs-full-stack-sites', null, null, null, null, false, null, ComposableSingletons$AboutKt_getInstance().a39_1, $composer_0, 12582918, 126);
    Text('.', $composer_0, 6);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
  ...
  function ComposableSingletons$AboutKt$lambda_60$lambda_arekjs($this$Pre, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().d39_1, $composer_0, 48, 1);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$AboutKt$lambda_62$lambda_2mgjay($this$P, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().f39_1, $composer_0, 48, 1);
    Text(' folder.', $composer_0, 6);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
  ...
  function ComposableSingletons$AboutKt$lambda_65$lambda_ctatwj($this$Pre, $composer, $changed) {
    ...
    Code(null, ComposableSingletons$AboutKt_getInstance().i39_1, $composer_0, 48, 1);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$AboutKt$lambda_68$lambda_s92740($this$P, $composer, $changed) {
    ...
    Text('You can ', $composer_0, 6);
    Link('https://bitspittle.dev/blog/2022/staticdeploy', null, null, null, null, false, null, ComposableSingletons$AboutKt_getInstance().l39_1, $composer_0, 12582918, 126);
  ...
  function ComposableSingletons$AboutKt$lambda_69$lambda_dyfdsx($composer, $changed) {
    ...
    if (!(($changed & 11) === 2) ? true : !$composer_0.n17()) {
      ...
      $composer_0.t17();
      H1(tmp0_group, ComposableSingletons$AboutKt_getInstance().x36_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().y36_1, $composer_0, 48, 1);
      HorizontalDivider(null, null, $composer_0, 0, 3);
      $composer_0.s17(120960172);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H2(tmp1_group, ComposableSingletons$AboutKt_getInstance().z36_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().a37_1, $composer_0, 48, 1);
      $composer_0.s17(120960539);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H3(tmp2_group, ComposableSingletons$AboutKt_getInstance().b37_1, $composer_0, 54, 0);
      $composer_0.s17(120960673);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp3_group, ComposableSingletons$AboutKt_getInstance().c37_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().e37_1, $composer_0, 48, 1);
      $composer_0.s17(120961294);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp4_group, ComposableSingletons$AboutKt_getInstance().f37_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().g37_1, $composer_0, 48, 1);
      $composer_0.s17(120961716);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp5_group, ComposableSingletons$AboutKt_getInstance().h37_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().i37_1, $composer_0, 48, 1);
      $composer_0.s17(120962073);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp6_group, ComposableSingletons$AboutKt_getInstance().j37_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().k37_1, $composer_0, 48, 1);
      Ul(null, ComposableSingletons$AboutKt_getInstance().r37_1, $composer_0, 48, 1);
      $composer_0.s17(120963643);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp7_group, ComposableSingletons$AboutKt_getInstance().s37_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().w37_1, $composer_0, 48, 1);
      $composer_0.s17(120964706);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      $composer_0.t17();
      H4(tmp8_group, ComposableSingletons$AboutKt_getInstance().x37_1, $composer_0, 54, 0);
      Ul(null, ComposableSingletons$AboutKt_getInstance().c38_1, $composer_0, 48, 1);
      $composer_0.s17(120965807);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_8 = $composer_0.w18();
      var tmp_17;
      if (false ? true : it_8 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_8 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_8;
        $composer_0.c19(value_8);
        tmp_17 = value_8;
      } else {
        tmp_17 = it_8;
      }
      ...
      $composer_0.t17();
      H3(tmp9_group, ComposableSingletons$AboutKt_getInstance().d38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().e38_1, $composer_0, 48, 1);
      $composer_0.s17(120966215);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_9 = $composer_0.w18();
      var tmp_19;
      if (false ? true : it_9 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_9 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_9;
        $composer_0.c19(value_9);
        tmp_19 = value_9;
      } else {
        tmp_19 = it_9;
      }
      ...
      $composer_0.t17();
      H4(tmp10_group, ComposableSingletons$AboutKt_getInstance().f38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().h38_1, $composer_0, 48, 1);
      $composer_0.s17(120966836);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_10 = $composer_0.w18();
      var tmp_21;
      if (false ? true : it_10 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_10 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_10;
        $composer_0.c19(value_10);
        tmp_21 = value_10;
      } else {
        tmp_21 = it_10;
      }
      ...
      $composer_0.t17();
      H4(tmp11_group, ComposableSingletons$AboutKt_getInstance().i38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().k38_1, $composer_0, 48, 1);
      $composer_0.s17(120967479);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_11 = $composer_0.w18();
      var tmp_23;
      if (false ? true : it_11 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_11 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_11;
        $composer_0.c19(value_11);
        tmp_23 = value_11;
      } else {
        tmp_23 = it_11;
      }
      ...
      $composer_0.t17();
      H4(tmp12_group, ComposableSingletons$AboutKt_getInstance().l38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().m38_1, $composer_0, 48, 1);
      $composer_0.s17(120967855);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_12 = $composer_0.w18();
      var tmp_25;
      if (false ? true : it_12 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_12 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_12;
        $composer_0.c19(value_12);
        tmp_25 = value_12;
      } else {
        tmp_25 = it_12;
      }
      ...
      $composer_0.t17();
      H4(tmp13_group, ComposableSingletons$AboutKt_getInstance().n38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().o38_1, $composer_0, 48, 1);
      $composer_0.s17(120968158);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_13 = $composer_0.w18();
      var tmp_27;
      if (false ? true : it_13 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_13 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_13;
        $composer_0.c19(value_13);
        tmp_27 = value_13;
      } else {
        tmp_27 = it_13;
      }
      ...
      $composer_0.t17();
      H2(tmp14_group, ComposableSingletons$AboutKt_getInstance().p38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().r38_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().s38_1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().u38_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().v38_1, $composer_0, 48, 1);
      $composer_0.s17(120969407);
      // Inline function 'androidx.compose.runtime.cache' call
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_14 = $composer_0.w18();
      var tmp_29;
      if (false ? true : it_14 === Companion_getInstance().k12_1) {
        // Inline function 'com.canerture.androidhub.pages.ComposableSingletons$AboutKt.lambda-69.<anonymous>.<anonymous>' call
        var value_14 = ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_14;
        $composer_0.c19(value_14);
        tmp_29 = value_14;
      } else {
        tmp_29 = it_14;
      }
      ...
      $composer_0.t17();
      H2(tmp15_group, ComposableSingletons$AboutKt_getInstance().w38_1, $composer_0, 54, 0);
      P(null, ComposableSingletons$AboutKt_getInstance().x38_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().b39_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().c39_1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().e39_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().g39_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().h39_1, $composer_0, 48, 1);
      Pre(null, ComposableSingletons$AboutKt_getInstance().j39_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().k39_1, $composer_0, 48, 1);
      P(null, ComposableSingletons$AboutKt_getInstance().m39_1, $composer_0, 48, 1);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng($this$H1) {
    $this$H1.t24('about-this-template');
    return Unit_instance;
  }
  ...
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_9($this$H4) {
    $this$H4.t24('modifier');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_10($this$H4) {
    $this$H4.t24('componentstyle');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_11($this$H4) {
    $this$H4.t24('componentvariant');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_12($this$H4) {
    $this$H4.t24('keyframes');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_13($this$H2) {
    $this$H2.t24('starting-point');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt$lambda_69$lambda$lambda_myrqng_14($this$H2) {
    $this$H2.t24('export-and-deploy');
    return Unit_instance;
  }
  function ComposableSingletons$AboutKt() {
    ComposableSingletons$AboutKt_instance = this;
    var tmp = this;
    tmp.x36_1 = ComposableLambda$invoke$ref_5(composableLambdaInstance(655888299, false, ComposableSingletons$AboutKt$lambda_1$lambda_irurs3));
    var tmp_0 = this;
    tmp_0.y36_1 = ComposableLambda$invoke$ref_6(composableLambdaInstance(443045834, false, ComposableSingletons$AboutKt$lambda_2$lambda_nfmt4u));
    var tmp_1 = this;
    tmp_1.z36_1 = ComposableLambda$invoke$ref_7(composableLambdaInstance(1882134090, false, ComposableSingletons$AboutKt$lambda_3$lambda_5dznxd));
    var tmp_2 = this;
    tmp_2.a37_1 = ComposableLambda$invoke$ref_8(composableLambdaInstance(574934067, false, ComposableSingletons$AboutKt$lambda_4$lambda_y7m4zk));
    var tmp_3 = this;
    tmp_3.b37_1 = ComposableLambda$invoke$ref_9(composableLambdaInstance(-1186587415, false, ComposableSingletons$AboutKt$lambda_5$lambda_7zvfxd));
    var tmp_4 = this;
    tmp_4.c37_1 = ComposableLambda$invoke$ref_10(composableLambdaInstance(39658376, false, ComposableSingletons$AboutKt$lambda_6$lambda_ktr14u));
    var tmp_5 = this;
    tmp_5.d37_1 = ComposableLambda$invoke$ref_11(composableLambdaInstance(-1055744463, false, ComposableSingletons$AboutKt$lambda_7$lambda_ldqjs3));
    var tmp_6 = this;
    tmp_6.e37_1 = ComposableLambda$invoke$ref_12(composableLambdaInstance(1801179858, false, ComposableSingletons$AboutKt$lambda_8$lambda_7fvxa4));
    var tmp_7 = this;
    tmp_7.f37_1 = ComposableLambda$invoke$ref_13(composableLambdaInstance(-533356431, false, ComposableSingletons$AboutKt$lambda_9$lambda_yrlnmt));
    var tmp_8 = this;
    tmp_8.g37_1 = ComposableLambda$invoke$ref_14(composableLambdaInstance(-1267541647, false, ComposableSingletons$AboutKt$lambda_10$lambda_i5qkjn));
    var tmp_9 = this;
    tmp_9.h37_1 = ComposableLambda$invoke$ref_15(composableLambdaInstance(692889360, false, ComposableSingletons$AboutKt$lambda_11$lambda_o1r0da));
    var tmp_10 = this;
    tmp_10.i37_1 = ComposableLambda$invoke$ref_16(composableLambdaInstance(-41295856, false, ComposableSingletons$AboutKt$lambda_12$lambda_4rvgox));
    var tmp_11 = this;
    tmp_11.j37_1 = ComposableLambda$invoke$ref_17(composableLambdaInstance(1919135151, false, ComposableSingletons$AboutKt$lambda_13$lambda_xlhxr4));
    var tmp_12 = this;
    tmp_12.k37_1 = ComposableLambda$invoke$ref_18(composableLambdaInstance(1184949935, false, ComposableSingletons$AboutKt$lambda_14$lambda_8lzn5t));
    var tmp_13 = this;
    tmp_13.l37_1 = ComposableLambda$invoke$ref_19(composableLambdaInstance(672559373, false, ComposableSingletons$AboutKt$lambda_15$lambda_k7mtwe));
    var tmp_14 = this;
    tmp_14.m37_1 = ComposableLambda$invoke$ref_20(composableLambdaInstance(1697742766, false, ComposableSingletons$AboutKt$lambda_16$lambda_lzur0j));
    var tmp_15 = this;
    tmp_15.n37_1 = ComposableLambda$invoke$ref_21(composableLambdaInstance(1820169028, false, ComposableSingletons$AboutKt$lambda_17$lambda_6trq1o));
    var tmp_16 = this;
    tmp_16.o37_1 = ComposableLambda$invoke$ref_22(composableLambdaInstance(-821068379, false, ComposableSingletons$AboutKt$lambda_18$lambda_zdpuv9));
    var tmp_17 = this;
    tmp_17.p37_1 = ComposableLambda$invoke$ref_23(composableLambdaInstance(1116306053, false, ComposableSingletons$AboutKt$lambda_19$lambda_6k3dt2));
    var tmp_18 = this;
    tmp_18.q37_1 = ComposableLambda$invoke$ref_24(composableLambdaInstance(-1524931354, false, ComposableSingletons$AboutKt$lambda_20$lambda_bqdg8s));
    var tmp_19 = this;
    tmp_19.r37_1 = ComposableLambda$invoke$ref_25(composableLambdaInstance(245760669, false, ComposableSingletons$AboutKt$lambda_21$lambda_h390tf));
    var tmp_20 = this;
    tmp_20.s37_1 = ComposableLambda$invoke$ref_26(composableLambdaInstance(-1149586354, false, ComposableSingletons$AboutKt$lambda_22$lambda_p48k3i));
    var tmp_21 = this;
    tmp_21.t37_1 = ComposableLambda$invoke$ref_27(composableLambdaInstance(-445728595, false, ComposableSingletons$AboutKt$lambda_23$lambda_3pdwyp));
    var tmp_22 = this;
    tmp_22.u37_1 = ComposableLambda$invoke$ref_28(composableLambdaInstance(1296049558, false, ComposableSingletons$AboutKt$lambda_24$lambda_wj0e0w));
    var tmp_23 = this;
    tmp_23.v37_1 = ComposableLambda$invoke$ref_29(composableLambdaInstance(951133813, false, ComposableSingletons$AboutKt$lambda_25$lambda_9oh6w1));
    var tmp_24 = this;
    tmp_24.w37_1 = ComposableLambda$invoke$ref_30(composableLambdaInstance(-1883771570, false, ComposableSingletons$AboutKt$lambda_26$lambda_j55a66));
    var tmp_25 = this;
    tmp_25.x37_1 = ComposableLambda$invoke$ref_31(composableLambdaInstance(76659437, false, ComposableSingletons$AboutKt$lambda_27$lambda_n2caqr));
    var tmp_26 = this;
    tmp_26.y37_1 = ComposableLambda$invoke$ref_32(composableLambdaInstance(2094112950, false, ComposableSingletons$AboutKt$lambda_28$lambda_5ra6bg));
    var tmp_27 = this;
    tmp_27.z37_1 = ComposableLambda$invoke$ref_33(composableLambdaInstance(-547124457, false, ComposableSingletons$AboutKt$lambda_29$lambda_ykwndn));
    var tmp_28 = this;
    tmp_28.a38_1 = ComposableLambda$invoke$ref_34(composableLambdaInstance(1140396333, false, ComposableSingletons$AboutKt$lambda_30$lambda_temkxx));
    var tmp_29 = this;
    tmp_29.b38_1 = ComposableLambda$invoke$ref_35(composableLambdaInstance(1236920142, false, ComposableSingletons$AboutKt$lambda_31$lambda_csuzz0));
    var tmp_30 = this;
    tmp_30.c38_1 = ComposableLambda$invoke$ref_36(composableLambdaInstance(-37548474, false, ComposableSingletons$AboutKt$lambda_32$lambda_g0rh37));
    var tmp_31 = this;
    tmp_31.d38_1 = ComposableLambda$invoke$ref_37(composableLambdaInstance(-2134522478, false, ComposableSingletons$AboutKt$lambda_33$lambda_q6q3tq));
    var tmp_32 = this;
    tmp_32.e38_1 = ComposableLambda$invoke$ref_38(composableLambdaInstance(-657525779, false, ComposableSingletons$AboutKt$lambda_34$lambda_2mwd8h));
    var tmp_33 = this;
    tmp_33.f38_1 = ComposableLambda$invoke$ref_39(composableLambdaInstance(1302905228, false, ComposableSingletons$AboutKt$lambda_35$lambda_vgiuao));
    var tmp_34 = this;
    tmp_34.g38_1 = ComposableLambda$invoke$ref_40(composableLambdaInstance(2006762987, false, ComposableSingletons$AboutKt$lambda_36$lambda_aqyqm9));
    var tmp_35 = this;
    tmp_35.h38_1 = ComposableLambda$invoke$ref_41(composableLambdaInstance(568720012, false, ComposableSingletons$AboutKt$lambda_37$lambda_i2nqfy));
    var tmp_36 = this;
    tmp_36.i38_1 = ComposableLambda$invoke$ref_42(composableLambdaInstance(-1765816277, false, ComposableSingletons$AboutKt$lambda_38$lambda_o4tugz));
    var tmp_37 = this;
    tmp_37.j38_1 = ComposableLambda$invoke$ref_43(composableLambdaInstance(-1061958518, false, ComposableSingletons$AboutKt$lambda_39$lambda_4osml8));
    var tmp_38 = this;
    tmp_38.k38_1 = ComposableLambda$invoke$ref_44(composableLambdaInstance(1794965803, false, ComposableSingletons$AboutKt$lambda_40$lambda_hhfui));
    var tmp_39 = this;
    tmp_39.l38_1 = ComposableLambda$invoke$ref_45(composableLambdaInstance(-539570486, false, ComposableSingletons$AboutKt$lambda_41$lambda_sc517p));
    var tmp_40 = this;
    tmp_40.m38_1 = ComposableLambda$invoke$ref_46(composableLambdaInstance(-1610511413, false, ComposableSingletons$AboutKt$lambda_42$lambda_dvcjp8));
    var tmp_41 = this;
    tmp_41.n38_1 = ComposableLambda$invoke$ref_47(composableLambdaInstance(686675305, false, ComposableSingletons$AboutKt$lambda_43$lambda_ey9xcz));
    var tmp_42 = this;
    tmp_42.o38_1 = ComposableLambda$invoke$ref_48(composableLambdaInstance(-384265622, false, ComposableSingletons$AboutKt$lambda_44$lambda_r97njy));
    var tmp_43 = this;
    tmp_43.p38_1 = ComposableLambda$invoke$ref_49(composableLambdaInstance(559278771, false, ComposableSingletons$AboutKt$lambda_45$lambda_1keti9));
    var tmp_44 = this;
    tmp_44.q38_1 = ComposableLambda$invoke$ref_50(composableLambdaInstance(1478401541, false, ComposableSingletons$AboutKt$lambda_46$lambda_ue1akg));
    var tmp_45 = this;
    tmp_45.r38_1 = ComposableLambda$invoke$ref_51(composableLambdaInstance(841980169, false, ComposableSingletons$AboutKt$lambda_47$lambda_btgach));
    var tmp_46 = this;
    tmp_46.s38_1 = ComposableLambda$invoke$ref_52(composableLambdaInstance(2068225960, false, ComposableSingletons$AboutKt$lambda_48$lambda_h066pq));
    var tmp_47 = this;
    tmp_47.t38_1 = ComposableLambda$invoke$ref_53(composableLambdaInstance(-187836906, false, ComposableSingletons$AboutKt$lambda_49$lambda_p7be77));
    var tmp_48 = this;
    tmp_48.u38_1 = ComposableLambda$invoke$ref_54(composableLambdaInstance(-1625879881, false, ComposableSingletons$AboutKt$lambda_50$lambda_udlgmx));
    var tmp_49 = this;
    tmp_49.v38_1 = ComposableLambda$invoke$ref_55(composableLambdaInstance(-1000495545, false, ComposableSingletons$AboutKt$lambda_51$lambda_1jyzkq));
    var tmp_50 = this;
    tmp_50.w38_1 = ComposableLambda$invoke$ref_56(composableLambdaInstance(1785524562, false, ComposableSingletons$AboutKt$lambda_52$lambda_r9nhhh));
    var tmp_51 = this;
    tmp_51.x38_1 = ComposableLambda$invoke$ref_57(composableLambdaInstance(225750246, false, ComposableSingletons$AboutKt$lambda_53$lambda_exu3fg));
    var tmp_52 = this;
    tmp_52.y38_1 = ComposableLambda$invoke$ref_58(composableLambdaInstance(2088417409, false, ComposableSingletons$AboutKt$lambda_54$lambda_dvsdmr));
    var tmp_53 = this;
    tmp_53.z38_1 = ComposableLambda$invoke$ref_59(composableLambdaInstance(223327736, false, ComposableSingletons$AboutKt$lambda_55$lambda_sbp7a6));
    var tmp_54 = this;
    tmp_54.a39_1 = ComposableLambda$invoke$ref_60(composableLambdaInstance(940845651, false, ComposableSingletons$AboutKt$lambda_56$lambda_hx9s1));
    var tmp_55 = this;
    tmp_55.b39_1 = ComposableLambda$invoke$ref_61(composableLambdaInstance(1451996037, false, ComposableSingletons$AboutKt$lambda_57$lambda_tbjqu8));
    var tmp_56 = this;
    tmp_56.c39_1 = ComposableLambda$invoke$ref_62(composableLambdaInstance(-1616725468, false, ComposableSingletons$AboutKt$lambda_58$lambda_cvxu2p));
    var tmp_57 = this;
    tmp_57.d39_1 = ComposableLambda$invoke$ref_63(composableLambdaInstance(-112990337, false, ComposableSingletons$AboutKt$lambda_59$lambda_fxomzi));
    var tmp_58 = this;
    tmp_58.e39_1 = ComposableLambda$invoke$ref_64(composableLambdaInstance(907180000, false, ComposableSingletons$AboutKt$lambda_60$lambda_arekjs));
    var tmp_59 = this;
    tmp_59.f39_1 = ComposableLambda$invoke$ref_65(composableLambdaInstance(1239179588, false, ComposableSingletons$AboutKt$lambda_61$lambda_vg30d5));
    var tmp_60 = this;
    tmp_60.g39_1 = ComposableLambda$invoke$ref_66(composableLambdaInstance(-390479677, false, ComposableSingletons$AboutKt$lambda_62$lambda_2mgjay));
    var tmp_61 = this;
    tmp_61.h39_1 = ComposableLambda$invoke$ref_67(composableLambdaInstance(835766114, false, ComposableSingletons$AboutKt$lambda_63$lambda_q75xr9));
    var tmp_62 = this;
    tmp_62.i39_1 = ComposableLambda$invoke$ref_68(composableLambdaInstance(1113255454, false, ComposableSingletons$AboutKt$lambda_64$lambda_g0bn5o));
    var tmp_63 = this;
    tmp_63.j39_1 = ComposableLambda$invoke$ref_69(composableLambdaInstance(2133425791, false, ComposableSingletons$AboutKt$lambda_65$lambda_ctatwj));
    var tmp_64 = this;
    tmp_64.k39_1 = ComposableLambda$invoke$ref_70(composableLambdaInstance(2043369740, false, ComposableSingletons$AboutKt$lambda_66$lambda_te6r0e));
    var tmp_65 = this;
    tmp_65.l39_1 = ComposableLambda$invoke$ref_71(composableLambdaInstance(-1536502151, false, ComposableSingletons$AboutKt$lambda_67$lambda_kk9y7));
    var tmp_66 = this;
    tmp_66.m39_1 = ComposableLambda$invoke$ref_72(composableLambdaInstance(-1025351765, false, ComposableSingletons$AboutKt$lambda_68$lambda_s92740));
    var tmp_67 = this;
    tmp_67.n39_1 = ComposableLambda$invoke$ref_73(composableLambdaInstance(1129324712, false, ComposableSingletons$AboutKt$lambda_69$lambda_dyfdsx));
  }
  ...
  function initColorMode(ctx) {
    ctx.m2t_1.c2u_1 = ColorMode_LIGHT_getInstance();
  }
  function AppEntry(content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(-230830174);
    var $dirty = $changed;
    if (($changed & 14) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(AppEntry$lambda_0(content, $changed));
    }
  }
  function AppEntry$lambda$slambda($colorMode, resultContinuation) {
    this.w39_1 = $colorMode;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(AppEntry$lambda$slambda).x1g = function ($this$LaunchedEffect, $completion) {
    var tmp = this.y1g($this$LaunchedEffect, $completion);
    tmp.yb_1 = Unit_instance;
    tmp.zb_1 = null;
    return tmp.ic();
  };
  protoOf(AppEntry$lambda$slambda).uc = function (p1, $completion) {
    return this.x1g((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(AppEntry$lambda$slambda).ic = function () {
    ...
    $sm: do
      try {
        ...
        if (tmp === 0) {
          this.xb_1 = 1;
          localStorage.setItem('androidhub:colorMode', this.w39_1.s9_1);
          return Unit_instance;
        } else if (tmp === 1) {
          throw this.zb_1;
        }
  ...
  protoOf(AppEntry$lambda$slambda).y1g = function ($this$LaunchedEffect, completion) {
    var i = new AppEntry$lambda$slambda(this.w39_1, completion);
    i.x39_1 = $this$LaunchedEffect;
    return i;
  };
  ...
  function AppEntry$lambda($content) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 11) === 2) ? true : !$composer_0.n17()) {
        ...
        var colorMode = Companion_instance_0.u2p($composer_0, 8);
        $composer_0.s17(-226072114);
        // Inline function 'androidx.compose.runtime.cache' call
        var invalid = $composer_0.lz(colorMode);
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        var it = $composer_0.w18();
        ...
        var tmp_2 = scrollBehavior(minHeight(toModifier(get_SmoothColorStyle(), [], $composer_0, 64), get_vh(100)), Companion_instance_1.w2e());
        // Inline function 'kotlin.run' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'com.canerture.androidhub.AppEntry.<anonymous>.<anonymous>.<anonymous>' call
        ...
        sourceInformation($composer_1, 'CC(remember)P(1):Composables.kt#9igjgp');
        // Inline function 'androidx.compose.runtime.cache' call
        var invalid_0 = $composer_1.lz(dispatchReceiver);
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        var it_0 = $composer_1.w18();
  ...
  function get_HeadlineTextStyle() {
    ...
    return HeadlineTextStyle$delegate.l2f(null, HeadlineTextStyle$factory());
  }
  var HeadlineTextStyle$delegate;
  function get_SubheadlineTextStyle() {
    _init_properties_AppStyles_kt__9fg0zz();
    return SubheadlineTextStyle$delegate.l2f(null, SubheadlineTextStyle$factory());
  }
  var SubheadlineTextStyle$delegate;
  function get_CircleButtonVariant() {
    _init_properties_AppStyles_kt__9fg0zz();
    return CircleButtonVariant$delegate.l2f(null, CircleButtonVariant$factory());
  }
  var CircleButtonVariant$delegate;
  function get_UncoloredButtonVariant() {
    _init_properties_AppStyles_kt__9fg0zz();
    return UncoloredButtonVariant$delegate.l2f(null, UncoloredButtonVariant$factory());
  }
  var UncoloredButtonVariant$delegate;
  function initSiteStyles(ctx) {
    _init_properties_AppStyles_kt__9fg0zz();
    registerStyleBase(ctx.n2t_1, 'body', VOID, initSiteStyles$lambda);
    var tmp = get_HorizontalDividerStyle();
    modifyComponentStyleBase(ctx.o2t_1, tmp, VOID, initSiteStyles$lambda_0);
  }
  function HeadlineTextStyle$delegate$lambda($this$base) {
    _init_properties_AppStyles_kt__9fg0zz();
    return lineHeight(textAlign(fontSize(Companion_instance_2, get_cssRem(3)), Companion_instance_3.j2c()), 1.2);
  }
  function SubheadlineTextStyle$delegate$lambda($this$base) {
    _init_properties_AppStyles_kt__9fg0zz();
    return color(textAlign(fontSize(Companion_instance_2, get_cssRem(1)), Companion_instance_3.j2c()), get_color(toPalette($this$base.r2r_1)).z2n().y2n(VOID, VOID, VOID, 0.8));
  }
  ...
  function UncoloredButtonVariant$delegate$lambda($this$addVariantBase) {
    _init_properties_AppStyles_kt__9fg0zz();
    return setVariable(Companion_instance_2, ButtonVars_getInstance().k2y(), Colors_instance.c2o());
  }
  ...
  function Brand(primary, accent) {
    primary = primary === VOID ? Companion_instance_5.a2o(3965935) : primary;
    accent = accent === VOID ? Companion_instance_5.a2o(15981403) : accent;
    this.y39_1 = primary;
    this.z39_1 = accent;
  }
  function SitePalette(nearBackground, cobweb, brand, green, white, blue) {
    this.a3a_1 = nearBackground;
    this.b3a_1 = cobweb;
    this.c3a_1 = brand;
    this.d3a_1 = green;
    this.e3a_1 = white;
  ...
  function SitePalettes() {
    ...
    this.g3a_1 = new SitePalette(Companion_instance_5.a2o(16447743), Colors_instance.l2o().s2n(), new Brand(Companion_instance_5.a2o(3965935), Companion_instance_5.a2o(15981403)), Companion_instance_5.a2o(6967017), Colors_instance.p2o(), Companion_instance_5.a2o(601922));
  }
  ...
  function getSitePalette() {
    return SitePalettes_getInstance().g3a_1;
  }
  function initTheme(ctx) {
    set_background(ctx.o2t_1.v2t_1.d2w_1, Companion_instance_5.a2o(16448250));
    set_color(ctx.o2t_1.v2t_1.d2w_1, Colors_instance.p2o());
  }
  function get_MarkdownStyle() {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    return MarkdownStyle$delegate.l2f(null, MarkdownStyle$factory());
  }
  var MarkdownStyle$delegate;
  function MarkdownLayout(title, content, $composer, $changed) {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(1489817358);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.lz(title) ? 4 : 2);
    if (($changed & 112) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(MarkdownLayout$lambda_0(title, content, $changed));
    }
  }
  function MarkdownStyle$delegate$lambda($this$ComponentStyle) {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    $this$ComponentStyle.f2r('h1', MarkdownStyle$delegate$lambda$lambda);
    $this$ComponentStyle.f2r('h2', MarkdownStyle$delegate$lambda$lambda_0);
    $this$ComponentStyle.f2r('h3', MarkdownStyle$delegate$lambda$lambda_1);
    $this$ComponentStyle.f2r('h4', MarkdownStyle$delegate$lambda$lambda_2);
    $this$ComponentStyle.f2r('p', MarkdownStyle$delegate$lambda$lambda_3);
    $this$ComponentStyle.f2r('ul', MarkdownStyle$delegate$lambda$lambda_4);
    $this$ComponentStyle.f2r('li,ol,ul', MarkdownStyle$delegate$lambda$lambda_5);
    $this$ComponentStyle.f2r('code', MarkdownStyle$delegate$lambda$lambda_6($this$ComponentStyle));
    $this$ComponentStyle.f2r('pre', MarkdownStyle$delegate$lambda$lambda_7);
    $this$ComponentStyle.f2r('pre > code', MarkdownStyle$delegate$lambda$lambda_8($this$ComponentStyle));
    return Unit_instance;
  }
  ...
  function MarkdownStyle$delegate$lambda$lambda_2() {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    return margin(fontWeight_0(fontSize(Companion_instance_2, get_cssRem(1.2)), Companion_instance_6.g2d()), get_cssRem(1), VOID, get_cssRem(0.5));
  }
  ...
  function MarkdownStyle$delegate$lambda$lambda_4() {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    return overflowWrap(fillMaxWidth(Companion_instance_2), Companion_instance_7.u2e());
  }
  ...
  function MarkdownStyle$delegate$lambda$lambda_6($this_ComponentStyle) {
    return function () {
      return fontWeight_0(color(Companion_instance_2, get_color(toPalette($this_ComponentStyle.b2r_1)).z2n().y2n(VOID, VOID, VOID, 0.8)), Companion_instance_6.g2d());
    };
  }
  ...
  function MarkdownStyle$delegate$lambda$lambda$lambda($this$overflow) {
    _init_properties_MarkdownLayout_kt__1k3pk7();
    $this$overflow.w2o(Companion_instance_8.s2e());
    return Unit_instance;
  }
  function MarkdownStyle$delegate$lambda$lambda_8($this_ComponentStyle) {
    return function () {
      ...
      // Inline function 'kotlin.js.asDynamic' call
      var tmp_0 = backgroundColor(fillMaxWidth(display(tmp, 'block')), getSitePalette().a3a_1);
      var tmp_1 = get_px(1);
      // Inline function 'org.jetbrains.compose.web.css.Companion.Solid' call
      // Inline function 'org.jetbrains.compose.web.css.LineStyle' call
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp_2 = fontSize(padding(borderRadius(border(tmp_0, tmp_1, 'solid', get_color(toPalette($this_ComponentStyle.b2r_1))), get_cssRem(0.25)), get_cssRem(0.5)), get_cssRem(1));
  ...
  function get_PageContentStyle() {
    ...
    return PageContentStyle$delegate.l2f(null, PageContentStyle$factory());
  }
  var PageContentStyle$delegate;
  function PageLayout(title, content, $composer, $changed) {
    _init_properties_PageLayout_kt__pf69s7();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(928443343);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.lz(title) ? 4 : 2);
    if (($changed & 112) === 0)
    ...
    if (!(($dirty & 91) === 18) ? true : !$composer_0.n17()) {
      ...
      var tmp_7;
      if (invalid_0 ? true : it_1 === Companion_getInstance().k12_1) {
    ...
    if (tmp2_safe_receiver == null)
      ...
      tmp2_safe_receiver.i1e(PageLayout$lambda_1(title, content, $changed));
    }
  }
  function PageContentStyle$delegate$lambda($this$ComponentStyle) {
    _init_properties_PageLayout_kt__pf69s7();
    $this$ComponentStyle.d2r(PageContentStyle$delegate$lambda$lambda);
  ...
  protoOf(PageLayout$slambda).x1g = function ($this$LaunchedEffect, $completion) {
    var tmp = this.y1g($this$LaunchedEffect, $completion);
    tmp.yb_1 = Unit_instance;
    tmp.zb_1 = null;
    return tmp.ic();
  };
  protoOf(PageLayout$slambda).uc = function (p1, $completion) {
    return this.x1g((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  };
  protoOf(PageLayout$slambda).ic = function () {
    var suspendResult = this.yb_1;
    $sm: do
      try {
        var tmp = this.wb_1;
        if (tmp === 0) {
          this.xb_1 = 1;
          document.title = 'AndroidHub - ' + this.p3a_1;
          return Unit_instance;
        } else if (tmp === 1) {
          throw this.zb_1;
        }
  ...
  protoOf(PageLayout$slambda).y1g = function ($this$LaunchedEffect, completion) {
    var i = new PageLayout$slambda(this.p3a_1, completion);
    i.q3a_1 = $this$LaunchedEffect;
    return i;
  };
  ...
  function PageLayout$lambda($this$gridTemplateRows) {
    _init_properties_PageLayout_kt__pf69s7();
    $this$gridTemplateRows.o2d(get_fr(1));
    $this$gridTemplateRows.n2d($this$gridTemplateRows.m2d());
    return Unit_instance;
  }
  ...
  function get_FooterStyle() {
    ...
    return FooterStyle$delegate.l2f(null, FooterStyle$factory());
  }
  ...
  function Footer(modifier, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(571317305);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 2;
    if (!(($default & 1) === 1) ? true : !(($dirty & 11) === 2) ? true : !$composer_0.n17()) {
      ...
      var tmp = toModifier(get_FooterStyle(), [], $composer_0, 64).e2n(modifier_0._v);
      var tmp_0 = Center_instance;
      Box(tmp, tmp_0, null, ComposableSingletons$FooterKt_getInstance().s3a_1, $composer_0, 3080, 4);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(Footer$lambda(modifier_0, $changed, $default));
    }
  }
  ...
  function ComposableSingletons$FooterKt$lambda_1$lambda_a73781($this$Span, $composer, $changed) {
    ...
    var tmp = setVariable(Companion_instance_2, get_ColorVar(), sitePalette.c3a_1.y39_1);
    ...
    var tmp_1 = whiteSpace(setVariable(Companion_instance_2, get_ColorVar(), sitePalette.c3a_1.z39_1), Companion_instance_11.p2f());
  ...
  function ComposableSingletons$FooterKt$lambda_2$lambda_imj9u6($this$Box, $composer, $changed) {
    ...
    Span(toAttrs(textAlign(Companion_instance_2, Companion_instance_3.i2c())), ComposableSingletons$FooterKt_getInstance().r3a_1, $composer_0, 48, 0);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$FooterKt() {
    ...
    var tmp = this;
    tmp.r3a_1 = ComposableLambda$invoke$ref_81(composableLambdaInstance(-1858395691, false, ComposableSingletons$FooterKt$lambda_1$lambda_a73781));
    var tmp_0 = this;
    tmp_0.s3a_1 = ComposableLambda$invoke$ref_82(composableLambdaInstance(-284662157, false, ComposableSingletons$FooterKt$lambda_2$lambda_imj9u6));
  }
  ...
  function FooterStyle$delegate$lambda($this$base) {
    _init_properties_Footer_kt__fc6p2z();
    return padding_1(backgroundColor(Companion_instance_2, getSitePalette().a3a_1), get_cssRem(1.5), get_percent(10));
  }
  ...
  function get_NavHeaderStyle() {
    ...
    return NavHeaderStyle$delegate.l2f(null, NavHeaderStyle$factory());
  }
  var NavHeaderStyle$delegate;
  function get_SideMenuSlideInAnim() {
    _init_properties_NavHeader_kt__vdotjy();
    return SideMenuSlideInAnim$delegate.l2f(null, SideMenuSlideInAnim$factory());
  }
  var SideMenuSlideInAnim$delegate;
  function NavLink(path, text, $composer, $changed) {
    _init_properties_NavHeader_kt__vdotjy();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(844555591);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.lz(path) ? 4 : 2);
    if (($changed & 112) === 0)
      $dirty = $dirty | ($composer_0.lz(text) ? 32 : 16);
    if (!(($dirty & 91) === 18) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(NavLink$lambda(path, text, $changed));
    }
  }
  function MenuItems($composer, $changed) {
    _init_properties_NavHeader_kt__vdotjy();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(-1327933143);
    if (!($changed === 0) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(MenuItems$lambda($changed));
    }
  }
  function HamburgerButton(onClick, $composer, $changed) {
    _init_properties_NavHeader_kt__vdotjy();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(1913630033);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.n18(onClick) ? 4 : 2);
    if (!(($dirty & 11) === 2) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
        traceEventStart(1913630033, $dirty, -1, 'com.canerture.androidhub.components.sections.HamburgerButton (NavHeader.kt:86)');
      }
      IconButton(onClick, ComposableSingletons$NavHeaderKt_getInstance().t3a_1, $composer_0, 48 | 14 & $dirty);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(HamburgerButton$lambda(onClick, $changed));
    }
  }
  function CloseButton(onClick, $composer, $changed) {
    _init_properties_NavHeader_kt__vdotjy();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(1136291648);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.n18(onClick) ? 4 : 2);
    if (!(($dirty & 11) === 2) ? true : !$composer_0.n17()) {
      ...
      IconButton(onClick, ComposableSingletons$NavHeaderKt_getInstance().u3a_1, $composer_0, 48 | 14 & $dirty);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(CloseButton$lambda(onClick, $changed));
    }
  }
  ...
  protoOf(SideMenuState).b3b = function () {
    var tmp;
    switch (this.t9_1) {
      case 0:
  ...
  function NavHeader($composer, $changed) {
    ...
    if (!($changed === 0) ? true : !$composer_0.n17()) {
      ...
      Row(tmp3_modifier, Center_instance_0, CenterVertically_instance, null, ComposableSingletons$NavHeaderKt_getInstance().x3a_1, $composer_0, 24584, 8);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.i1e(NavHeader$lambda_2($changed));
    }
  }
  function SideMenu(menuState, close, onAnimationEnd, $composer, $changed) {
    _init_properties_NavHeader_kt__vdotjy();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(1445021827);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.lz(menuState) ? 4 : 2);
    if (($changed & 112) === 0)
      $dirty = $dirty | ($composer_0.n18(close) ? 32 : 16);
    if (($changed & 896) === 0)
      $dirty = $dirty | ($composer_0.n18(onAnimationEnd) ? 256 : 128);
    if (!(($dirty & 731) === 146) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
        traceEventStart(1445021827, $dirty, -1, 'com.canerture.androidhub.components.sections.SideMenu (NavHeader.kt:175)');
      }
      var tmp = setVariable(Companion_instance_2, OverlayVars_getInstance().v2x(), Colors_instance.c2o());
      $composer_0.s17(-760353971);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.i1e(SideMenu$lambda_1(menuState, close, onAnimationEnd, $changed));
    }
  }
  ...
  function ComposableSingletons$NavHeaderKt$lambda_5$lambda_cecns2($this$Row, $composer, $changed) {
    ...
    Row(tmp_2, null, tmp_3, null, ComposableSingletons$NavHeaderKt_getInstance().w3a_1, $composer_0, 24584, 10);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$NavHeaderKt() {
    ...
    var tmp = this;
    tmp.t3a_1 = ComposableLambda$invoke$ref_83(composableLambdaInstance(1563565610, false, ComposableSingletons$NavHeaderKt$lambda_1$lambda_vv16hm));
    var tmp_0 = this;
    tmp_0.u3a_1 = ComposableLambda$invoke$ref_84(composableLambdaInstance(1424045209, false, ComposableSingletons$NavHeaderKt$lambda_2$lambda_31epff));
    var tmp_1 = this;
    tmp_1.v3a_1 = ComposableLambda$invoke$ref_85(composableLambdaInstance(61045801, false, ComposableSingletons$NavHeaderKt$lambda_3$lambda_ps7rms));
    var tmp_2 = this;
    tmp_2.w3a_1 = ComposableLambda$invoke$ref_86(composableLambdaInstance(-342585411, false, ComposableSingletons$NavHeaderKt$lambda_4$lambda_gf9ta5));
    var tmp_3 = this;
    tmp_3.x3a_1 = ComposableLambda$invoke$ref_87(composableLambdaInstance(-653953120, false, ComposableSingletons$NavHeaderKt$lambda_5$lambda_cecns2));
    var tmp_4 = this;
    tmp_4.y3a_1 = ComposableLambda$invoke$ref_88(composableLambdaInstance(1280507252, false, ComposableSingletons$NavHeaderKt$lambda_6$lambda_tt4x4v));
  }
  ...
  function SideMenuSlideInAnim$delegate$lambda($this$Keyframes) {
    _init_properties_NavHeader_kt__vdotjy();
    $this$Keyframes.h2p(SideMenuSlideInAnim$delegate$lambda$lambda);
    $this$Keyframes.i2p(SideMenuSlideInAnim$delegate$lambda$lambda_0);
    return Unit_instance;
  }
  ...
  function NavHeader$lambda$lambda$lambda_0($menuState$delegate) {
    return function () {
      NavHeader$lambda_0($menuState$delegate, NavHeader$lambda($menuState$delegate).b3b());
      return Unit_instance;
    };
  }
  ...
  function NavHeader$lambda_1($menuState$delegate) {
    return function ($this$Row, $composer, $changed) {
      ...
      Link('https://androidhub.dev', null, null, null, null, false, null, ComposableSingletons$NavHeaderKt_getInstance().v3a_1, $composer_0, 12582918, 126);
  ...
  function SideMenu$lambda$lambda_1($close) {
    return function ($this$Column, $composer, $changed) {
      ...
      $composer_0.s17(-1518991120);
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = $composer_0.lz($close);
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it = $composer_0.w18();
      ...
      Column(tmp_1, null, tmp_2, null, ComposableSingletons$NavHeaderKt_getInstance().y3a_1, $composer_0, 24584, 10);
      var tmp_3;
      if (isTraceInProgress()) {
        traceEventEnd();
        tmp_3 = Unit_instance;
  ...
  function SideMenu$lambda_0($menuState, $onAnimationEnd, $close) {
    return function ($this$Overlay, $composer, $changed) {
      ...
      $composer_0.v14(629540746, $menuState);
      var tmp = backgroundColor(gap(padding_0($this$Overlay.r2m(width(fillMaxHeight(Companion_instance_2), clamp(get_cssRem(8), get_percent(33), get_cssRem(10))), CenterEnd_instance), get_cssRem(1), get_cssRem(1)), get_cssRem(1.5)), getSitePalette().a3a_1);
      ...
      $composer_0.s17(629542062);
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = $composer_0.lz($onAnimationEnd);
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      var it_0 = $composer_0.w18();
  ...
  function IconButton(onClick, content, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(-2093742643);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.n18(onClick) ? 4 : 2);
    if (($changed & 112) === 0)
    ...
    if (!(($dirty & 91) === 18) ? true : !$composer_0.n17()) {
      ...
      var tmp0_group = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
      $composer_0.t17();
      var tmp_1 = setVariable(Companion_instance_2, ButtonVars_getInstance().o2y(), get_em(1));
      var tmp_2 = get_CircleButtonVariant().s2r(get_UncoloredButtonVariant());
      // Inline function 'kotlin.run' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'com.canerture.androidhub.components.widgets.IconButton.<anonymous>' call
      var tmp_3 = $composer_0;
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.i1e(IconButton$lambda_1(onClick, content, $changed));
    }
  }
  ...
  function get_HeroContainerStyle() {
    ...
    return HeroContainerStyle$delegate.l2f(null, HeroContainerStyle$factory());
  }
  var HeroContainerStyle$delegate;
  function get_HomeGridStyle() {
    _init_properties_Index_kt__ifxcv4();
    return HomeGridStyle$delegate.l2f(null, HomeGridStyle$factory());
  }
  var HomeGridStyle$delegate;
  function get_GridCellColorVar() {
    _init_properties_Index_kt__ifxcv4();
    return GridCellColorVar$delegate.l2f(null, GridCellColorVar$factory());
  }
  var GridCellColorVar$delegate;
  function get_HomeGridCellStyle() {
    _init_properties_Index_kt__ifxcv4();
    return HomeGridCellStyle$delegate.l2f(null, HomeGridCellStyle$factory());
  }
  ...
  function GridCell(color, row, column, width, height, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(1898381357);
    if (!(($default & 8) === 0)) {
      width_0._v = null;
    }
    if (!(($default & 16) === 0)) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(GridCell$lambda(color, row, column, width_0, height_0, $changed, $default));
    }
  }
  function HomePage($composer, $changed) {
    _init_properties_Index_kt__ifxcv4();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.k19(-763277764);
    if (!($changed === 0) ? true : !$composer_0.n17()) {
      if (isTraceInProgress()) {
        traceEventStart(-763277764, $changed, -1, 'com.canerture.androidhub.pages.HomePage (Index.kt:67)');
      }
      PageLayout('Home', ComposableSingletons$IndexKt_getInstance().h3b_1, $composer_0, 54);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.i1e(HomePage$lambda($changed));
    }
  }
  ...
  function ComposableSingletons$IndexKt$lambda_3$lambda$lambda$lambda_o3atbu($sitePalette) {
    return function ($this$Div, $composer, $changed) {
      ...
      var tmp = Companion_instance_2;
      var tmp_0;
      switch (Companion_instance_0.u2p($composer_0, 8).t9_1) {
        case 0:
          tmp_0 = Colors_instance.d2o();
          break;
        case 1:
          tmp_0 = Colors_instance.p2o();
          break;
        default:
          noWhenBranchMatchedException();
          break;
      ...
      var tmp_2 = textShadow(color(Companion_instance_2, $sitePalette.c3a_1.z39_1), get_px(0), get_px(0), get_cssRem(0.5), Colors_instance.k2o());
  ...
  function ComposableSingletons$IndexKt$lambda_3$lambda$lambda_h8z03p($sitePalette) {
    return function ($this$Column, $composer, $changed) {
      ...
      Div(toAttrs_0(tmp_4, [], null, $composer_0, 64, 2), ComposableSingletons$IndexKt_getInstance().c3b_1, $composer_0, 48, 0);
      ...
      Button(tmp_5, null, null, null, false, null, tmp_6, null, null, ComposableSingletons$IndexKt_getInstance().d3b_1, $composer_0, 805306368, 446);
      var tmp_7;
      if (isTraceInProgress()) {
        traceEventEnd();
        tmp_7 = Unit_instance;
  ...
  function ComposableSingletons$IndexKt$lambda_4$lambda_le2j7p($this$Div, $composer, $changed) {
    ...
    var sitePalette = getSitePalette();
    GridCell(sitePalette.c3a_1.y39_1, 1, 1, 2, 2, $composer_0, 28088, 0);
    var tmp = Monochrome_getInstance().p2u_1;
    GridCell(tmp, 1, 3, null, null, $composer_0, 432, 24);
    var tmp_0 = Monochrome_getInstance().k2u_1;
    GridCell(tmp_0, 1, 4, 2, null, $composer_0, 3504, 16);
    GridCell(sitePalette.c3a_1.z39_1, 2, 3, 2, null, $composer_0, 3512, 16);
    var tmp_1 = Monochrome_getInstance().m2u_1;
    GridCell(tmp_1, 2, 5, null, null, $composer_0, 432, 24);
    var tmp_2 = Monochrome_getInstance().r2u_1;
  ...
  function ComposableSingletons$IndexKt$lambda_5$lambda_ktf1p8($this$Row, $composer, $changed) {
    ...
    Box(null, null, null, ComposableSingletons$IndexKt_getInstance().e3b_1, $composer_0, 3072, 7);
    var tmp = displayIfAtLeast(toModifier(get_HomeGridStyle(), [], $composer_0, 64), Breakpoint_MD_getInstance());
    $composer_0.s17(16459822);
    // Inline function 'androidx.compose.runtime.cache' call
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    ...
    var tmp0_group = (tmp_1 == null ? true : !(tmp_1 == null)) ? tmp_1 : THROW_CCE();
    $composer_0.t17();
    Div(toAttrs(grid(tmp, tmp0_group)), ComposableSingletons$IndexKt_getInstance().f3b_1, $composer_0, 48, 0);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$IndexKt$lambda_5$lambda$lambda_3x0x15($this$grid) {
    $this$grid.h2e(ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda_kgzzy4);
    $this$grid.g2e(ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda_kgzzy4_0);
    return Unit_instance;
  }
  function ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda_kgzzy4($this$rows) {
    $this$rows.j2d(3, ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda$lambda_o33jyx);
    return Unit_instance;
  }
  ...
  function ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda_kgzzy4_0($this$columns) {
    $this$columns.j2d(5, ComposableSingletons$IndexKt$lambda_5$lambda$lambda$lambda$lambda_o33jyx_0);
    return Unit_instance;
  }
  ...
  function ComposableSingletons$IndexKt$lambda_6$lambda_807fcz($this$PageLayout, $composer, $changed) {
    ...
    Row(tmp, null, null, null, ComposableSingletons$IndexKt_getInstance().g3b_1, $composer_0, 24584, 14);
    if (isTraceInProgress()) {
      traceEventEnd();
    }
    return Unit_instance;
  ...
  function ComposableSingletons$IndexKt() {
    ...
    var tmp = this;
    tmp.c3b_1 = ComposableLambda$invoke$ref_94(composableLambdaInstance(1260269097, false, ComposableSingletons$IndexKt$lambda_1$lambda_5yb608));
    var tmp_0 = this;
    tmp_0.d3b_1 = ComposableLambda$invoke$ref_95(composableLambdaInstance(1692940003, false, ComposableSingletons$IndexKt$lambda_2$lambda_yrxn2f));
    var tmp_1 = this;
    tmp_1.e3b_1 = ComposableLambda$invoke$ref_96(composableLambdaInstance(-596361092, false, ComposableSingletons$IndexKt$lambda_3$lambda_7fjxui));
    var tmp_2 = this;
    tmp_2.f3b_1 = ComposableLambda$invoke$ref_99(composableLambdaInstance(-1935791819, false, ComposableSingletons$IndexKt$lambda_4$lambda_le2j7p));
    var tmp_3 = this;
    tmp_3.g3b_1 = ComposableLambda$invoke$ref_100(composableLambdaInstance(-197148810, false, ComposableSingletons$IndexKt$lambda_5$lambda_ktf1p8));
    var tmp_4 = this;
    tmp_4.h3b_1 = ComposableLambda$invoke$ref_101(composableLambdaInstance(-1997478029, false, ComposableSingletons$IndexKt$lambda_6$lambda_807fcz));
  }
  ...
  function HeroContainerStyle$delegate$lambda($this$ComponentStyle) {
    _init_properties_Index_kt__ifxcv4();
    $this$ComponentStyle.d2r(HeroContainerStyle$delegate$lambda$lambda);
    var tmp = Breakpoint_MD_getInstance();
    $this$ComponentStyle.y2p(tmp, HeroContainerStyle$delegate$lambda$lambda_0);
    return Unit_instance;
  }
  ...
  function HomeGridCellStyle$delegate$lambda($this$base) {
    _init_properties_Index_kt__ifxcv4();
    return borderRadius(boxShadow(backgroundColor(Companion_instance_2, get_GridCellColorVar().f2f()), VOID, VOID, get_cssRem(0.6), VOID, get_GridCellColorVar().f2f()), get_cssRem(1));
  }
